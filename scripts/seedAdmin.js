/**
 * Admin & Secretary Seeding Script
 * Seeds 33 District Secretary accounts and 10 State Admin accounts.
 */
...
const { MONGO_URI, TELANGANA_DISTRICTS } = require('../config/constants');
...
async function seed() {
  try {
    ...
    console.log(`Seeded ${TELANGANA_DISTRICTS.length} District Secretary accounts.`);
